...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { name: @band.name, upcoming_event_count: @band.upcoming_event_count } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { name: @band.name, upcoming_event_count: @band.upcoming_event_count } }
